...
func main() {
  ...
  cmdCreate := &cobra.Command {
    ...
    Run: func(cmd *cobra.Command, args []string) {
      ...
      if (createPlatform != "") {
        if (createPlatform != "k8s" && createPlatform != "k3s" && createPlatform != "none" && createPlatform != "dockeree" && createPlatform != "ocp3" && createPlatform != "ocp3c" && createPlatform != "ocp4") { die("Invalid platform '" + createPlatform + "'") }
