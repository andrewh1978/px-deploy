...
func main() {
  ...
  cmdCreate := &cobra.Command {
    ...
    Run: func(cmd *cobra.Command, args []string) {
      ...
      if (createPlatform != "") {
        if (createPlatform != "k8s" && createPlatform != "k3s" && createPlatform != "ocp3" && createPlatform != "ocp3c") { die("Invalid platform '" + createPlatform + "'") }
  ...
  cmdCreate.Flags().StringVarP(&createPlatform, "platform", "p", "", "k8s | k3s | ocp3 | ocp3c (default " + defaults.Platform + ")")
