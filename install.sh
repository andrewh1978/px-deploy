...
>>>>>>> 5536a0ede4e4b8903ff829e4b00d17c60f981d6a
...
echo -e "${WHITE}alias px-deploy='docker run -it -e PXDUSER=\$USER --rm --name px-deploy.\$\$ -v \$HOME/.px-deploy:/px-deploy/.px-deploy -v \$HOME/.aws/credentials:/root/.aws/credentials -v \$HOME/.config/gcloud:/root/.config/gcloud -v \$HOME/.azure:/root/.azure px-deploy /root/go/bin/px-deploy'"
echo
